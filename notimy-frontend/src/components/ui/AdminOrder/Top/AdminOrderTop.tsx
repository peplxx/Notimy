...
const AdminOrderTop: React.FC<Props> = ({ title, backgroundStyle }) => {
    ...
    return (
        <div className={styles.top} style={backgroundStyle}>
            ...
            >
                <div className={styles.deleteBtn}>
                    <svg className={styles.deleteIcon} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48"
